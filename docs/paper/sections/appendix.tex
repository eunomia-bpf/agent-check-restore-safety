...
the root-selection input, commitment key, private summary, extractor, and
private commitments are withheld during anonymous review.  The anonymous
supplement contains the complete Lean development and audit driver, the
compiler and independent verifier, private-data-free tests, and the bounded
scaling driver.  TraceLab is identified by its public release tag and digest,
not redistributed.  No private output is required to verify a safety claim.
